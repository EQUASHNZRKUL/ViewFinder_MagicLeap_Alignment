...
namespace MagicLeap
{
    ...
    public class RawVideoCaptureCustom : MonoBehaviour
    {
        ...
        private MLCameraResultExtras _cached_extras; 
        private YUVFrameInfo _cached_frameData;
        private MLCameraFrameMetadata _cached_frameMetadata;
